          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              delay: 0.3
                ...
                <Button variant="ghost" onClick={() => scrollToSection("about")} className="relative group text-primary-foreground">
                  About
                  <motion.div className="absolute bottom-0 left-0 right-0 h-0.5 bg-accent scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
                </Button>
              </motion.div>
        ...
        opacity: 0
          ...
          duration: 0.3
            ...
            scale: 0.95
                ...
                <Button variant="ghost" onClick={() => scrollToSection("about")} className="text-2xl text-foreground hover:text-accent">
                  About
                </Button>
              </motion.div>
              <motion.div whileHover={{
