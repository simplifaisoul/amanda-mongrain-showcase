  ...
  return (
    <section id="projects" className="relative py-24 px-6 bg-background overflow-hidden">
      ...
      <motion.div 
        ...
        animate={{
          background: [
            "radial-gradient(circle at 20% 50%, hsl(340 75% 65% / 0.1) 0%, transparent 50%)",
            "radial-gradient(circle at 80% 50%, hsl(340 75% 65% / 0.1) 0%, transparent 50%)",
            "radial-gradient(circle at 20% 50%, hsl(340 75% 65% / 0.1) 0%, transparent 50%)",
          ]
        }}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <Card 
                className="group h-full relative overflow-hidden border-2 hover:border-accent/50 transition-all duration-500 hover:shadow-2xl"
              >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.skills.map((skill, skillIndex) => (
                      ...
                      >
                        <Badge 
                          variant="outline"
                          className="text-xs hover:border-accent transition-colors"
                        >
                          {skill}
                        </Badge>
                      </motion.div>
