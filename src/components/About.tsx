      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {strengths.map((strength, index) => (
            ...
            >
              <Card 
                className="p-8 h-full hover:shadow-2xl transition-all duration-500 border-2 hover:border-accent/30 relative overflow-hidden group"
              >
                ...
                <div className="flex flex-col items-center text-center space-y-4 relative z-10">
                  <motion.div 
                    className="p-4 rounded-full bg-accent/10 group-hover:bg-accent/20 transition-colors duration-300"
                ...
                {/* Corner accent */}
                <motion.div
                  className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-accent/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
